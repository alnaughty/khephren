...
final _contractAbi = _i1.ContractAbi.fromJson(
    '[{"inputs":[{"internalType":"address","name":"_poolImplementation","type":"address"}],"stateMutability":"nonpayable","type":"constructor"},{"anonymous":false,"inputs":[{"indexed":false,"internalType":"address","name":"owner","type":"address"},{"indexed":false,"internalType":"address","name":"poolAddress","type":"address"},{"indexed":false,"internalType":"uint256","name":"time","type":"uint256"}],"name":"createPool721EVT","type":"event"},{"inputs":[{"internalType":"uint256[]","name":"_dates","type":"uint256[]"},{"internalType":"uint16[]","name":"_data","type":"uint16[]"}],"name":"createPool721","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"getAllPool","outputs":[{"internalType":"address[]","name":"","type":"address[]"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"_nftAddress","type":"address"},{"internalType":"bytes[3]","name":"_projectdetails","type":"bytes[3]"},{"internalType":"address","name":"_project721Owner","type":"address"}],"name":"setProjectDetails","outputs":[],"stateMutability":"nonpayable","type":"function"}]',
    'Project721');

class Project721 extends _i1.GeneratedContract {
  Project721(
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> setProjectDetails(_i1.EthereumAddress _nftAddress,
      List<_i2.Uint8List> _projectdetails, _i1.EthereumAddress _project721Owner,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[3];
    assert(checkSignature(function, '180f88e4'));
    final params = [_nftAddress, _projectdetails, _project721Owner];
    return write(credentials, transaction, function, params);
  }
